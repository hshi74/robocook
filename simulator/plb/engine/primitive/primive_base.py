...
class Primitive:
    ...
    @ti.kernel
    def sdfpy(self, f: ti.i32, grid_pos: ti.ext_arr()) -> ti.f32:
        grid_pos2 = ti.Vector([grid_pos[0], grid_pos[1], grid_pos[2]])
        return length(grid_pos2 - self.position[f]) - self.radius
