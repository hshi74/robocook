...
_C.SIMULATOR = CN()
_C.SIMULATOR.dim = 3
_C.SIMULATOR.quality = 1  # control the number of particles and size of the grids (2 is orig)
...
#TODO: harry added it
RENDERER.camera_pos_1 = (0.5, 2.5, 2.2)
RENDERER.camera_rot_1 = (0.8, 0.)
RENDERER.camera_pos_2 = (0.5, 2.5, 2.2)
RENDERER.camera_rot_2 = (0.8, 0.)
RENDERER.camera_pos_3 = (0.5, 2.5, 2.2)
RENDERER.camera_rot_3 = (0.8, 0.)
RENDERER.camera_pos_4 = (0.5, 2.5, 2.2)
RENDERER.camera_rot_4 = (0.8, 0.)
